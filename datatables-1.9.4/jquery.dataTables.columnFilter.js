...
* 
* Parameters:"
* @sPlaceHolder                 String      Place where inline filtering function should be placed ("THead", "thead:before", "thead:after"). Default is "THead"
...
(function ($) {
    ...
    $.fn.columnFilter = function (options) {
                ...
                oSettings.aoDrawCallback.push({
                    "fn": (function (iColumn, nTh, sLabel) {
                        return function (oSettings) {
                            // Only rebuild the select on the first draw - i.e. when the Ajax
        ...
        return this.each(function () {
            ...
            var aoFilterCells = oTable.fnSettings().aoHeader[1];

            var oHost = oTable.fnSettings().nTHead; //Before fix for ColVis
